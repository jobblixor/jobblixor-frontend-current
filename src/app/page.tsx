        ...
        <>
          <section className="w-full py-4 text-center">
            ...
            <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
              Streamline your job search with our Chrome extension! Jobblixor applies inside your browser while you browse. If you would like, you can watch the entire process unfold in real time. Click the directions button to get set up and see how it works. Have questions or feedback? Reach out anytime at jobblixor@gmail.com. I check emails daily.
            </p>
          </section>
